	...
	do j = 1, 64
		...
		do i = 1, ictw1(ib216)
			...
			do k = 1, 3
				...
				ict = ict + 1
				m = (i - 1) * 3 + k
				rcnfgx(ict) = rxw1(m, ib216)
				rcnfgy(ict) = ryw1(m, ib216)
				rcnfgz(ict) = rzw1(m, ib216)
	...
	do j = 1, 64
		...
		do i = 1, ictw2(ib512)
			...
			do k = 1, 3
				...
				ict = ict + 1
				m = (i - 1) * 3 + k
				rcnfgx(ict) = rxw2(m, ib512)
				rcnfgy(ict) = ryw2(m, ib512)
				rcnfgz(ict) = rzw2(m, ib512)
	...
	do j = 1, 64
		...
		do i = 1, icts(ib1000)
			...
			do k = 1, 29
				...
				ict = ict + 1
				m = (i - 1) * 29 + k
				rcnfgx(ict) = rxs(m, ib1000)
				rcnfgy(ict) = rys(m, ib1000)
				rcnfgz(ict) = rzs(m, ib1000)
